...
import PartniorsSection from "../../admin/components/PartniorsSection";

export default function ManagerPartniorsPage() {
  ...
  const allowed = userRole === "MANAGER" || userRole === "MANAGER_ASSISTANT";
  if (!session || !allowed) {
    return null;
  }
