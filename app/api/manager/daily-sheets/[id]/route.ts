    ...
    const updateData = {
      ...
      items: {
        create: items?.map((item: any) => ({
          ...
          weight: typeof item.weight === "number" ? item.weight : Number(String(item.weight ?? "").replace(",", ".")) || 0,
          received: typeof item.received === "number" ? item.received : Number(String(item.received ?? "").replace(",", ".")) || 0,
          washCount: typeof item.washCount === "number" ? item.washCount : Number(String(item.washCount ?? "").replace(",", ".")) || 0,
          dispatched: typeof item.dispatched === "number" ? item.dispatched : Number(String(item.dispatched ?? "").replace(",", ".")) || 0,
          shortage: typeof item.shortage === "number" ? item.shortage : Number(String(item.shortage ?? "").replace(",", ".")) || 0,
          totalWeight: typeof item.totalWeight === "number" ? item.totalWeight : Number(String(item.totalWeight ?? "").replace(",", ".")) || 0,
