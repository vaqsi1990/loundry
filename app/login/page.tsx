...
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (loginType === "HOTEL") {
      ...
      const loginValue = staffLogin.trim();
      if (!loginValue) {
        setError("გთხოვთ შეიყვანოთ ელფოსტა ან პირადი ნომერი");
        return;
      }
      ...
      const staffUsesEmail = loginValue.includes("@");
            ...
            <div className="bg-white shadow rounded-lg p-6 space-y-6">
              <div>
                <input
                  ...
                  className="appearance-none placeholder:text-black placeholder:text-[18px] relative block w-full px-3 py-2 border text-black rounded-md text-[16px] md:text-[18px]"
                  placeholder="ელფოსტა ან პირადი ნომერი"
                  value={staffLogin}
