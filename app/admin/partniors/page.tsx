...
import PartniorsSection from "../components/PartniorsSection";

export default function AdminPartniorsPage() {
  ...
  const allowed = userRole === "ADMIN" || userRole === "MANAGER" || userRole === "MANAGER_ASSISTANT";
  if (!session || !allowed) {
    return null;
  }
    ...
    <div className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 mt-10 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <Link
              href={userRole === "ADMIN" ? "/admin" : "/manager"}
