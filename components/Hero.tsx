...
const slides = [
  {
    id: 1,
    title: 'სასტუმროს თეთრეულის პროფესიონალური რეცხვა',
    description: 'ჩვენ ვზრუნავთ თქვენი თეთრეულის ხარისხზე',
    image: '/engin-akyurt-yCYVV8-kQNM-unsplash.jpg',
  },
  {
    id: 2,
    title: 'სწრაფი და ეფექტური მომსახურება',
    description: 'თანამედროვე ტექნოლოგიებითა და პროფესიონალური გუნდით, გემსახურებით სწრაფად, ეფექტურად, ხარისხიანად',
    image: '/Marriott-frameworks-bed-bedding-set-MAR-101-FW_xlrg.jpg',
  },
  {
    id: 3,
    title: 'ჩვენთვის მთავარი ხარისხია',
    description: 'ორიენტირებული ვართ მხოლოდ და მხოლოდ თეთრეულის ხარისხზე!',
